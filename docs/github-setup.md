...
```text
org.modeljars:modeljars:0.1.12
  -> org.modeljars:modeljars-core:0.1.12
  -> com.integrallis:models:0.3.5
  -> com.integrallis:backend-java:0.3.5
  -> com.integrallis:backend-native:0.3.5
```
...
`org.modeljars:modeljars-cli:0.1.12` to GitHub Packages, and updates the Integrallis Homebrew tap and
