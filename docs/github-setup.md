...
```text
org.modeljars:modeljars:0.1.16
  -> org.modeljars:modeljars-core:0.1.16
  -> com.integrallis:models:0.3.9
  -> com.integrallis:backend-java:0.3.9
  -> com.integrallis:backend-native:0.3.9
```
...
`org.modeljars:modeljars-cli:0.1.16` to GitHub Packages, and updates the Integrallis Homebrew tap and
