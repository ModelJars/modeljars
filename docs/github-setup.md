...
```text
org.modeljars:modeljars:0.1.39
  -> org.modeljars:modeljars-core:0.1.39
...
`org.modeljars:modeljars-cli:0.1.39` to GitHub Packages, and updates the Integrallis Homebrew tap and
