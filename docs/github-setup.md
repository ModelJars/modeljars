...
```text
org.modeljars:modeljars:0.1.32
  -> org.modeljars:modeljars-core:0.1.32
  -> com.integrallis:models:0.3.26
  -> com.integrallis:backend-java:0.3.26
  -> com.integrallis:backend-native:0.3.26
```
...
`org.modeljars:modeljars-cli:0.1.32` to GitHub Packages, and updates the Integrallis Homebrew tap and
