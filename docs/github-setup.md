...
```text
org.modeljars:modeljars:0.1.8
  -> org.modeljars:modeljars-core:0.1.8
  -> com.integrallis:models:0.3.2
  -> com.integrallis:backend-java:0.3.2
  -> com.integrallis:backend-native:0.3.2
```
...
`org.modeljars:modeljars-cli:0.1.8` to GitHub Packages, and updates the Integrallis Homebrew tap and
