...
```text
org.modeljars:modeljars:0.1.29
  -> org.modeljars:modeljars-core:0.1.29
  -> com.integrallis:models:0.3.22
  -> com.integrallis:backend-java:0.3.22
  -> com.integrallis:backend-native:0.3.22
```
...
`org.modeljars:modeljars-cli:0.1.29` to GitHub Packages, and updates the Integrallis Homebrew tap and
