...
```text
org.modeljars:modeljars:0.1.13
  -> org.modeljars:modeljars-core:0.1.13
  -> com.integrallis:models:0.3.6
  -> com.integrallis:backend-java:0.3.6
  -> com.integrallis:backend-native:0.3.6
```
...
`org.modeljars:modeljars-cli:0.1.13` to GitHub Packages, and updates the Integrallis Homebrew tap and
