...
```text
org.modeljars:modeljars:0.1.17
  -> org.modeljars:modeljars-core:0.1.17
...
`org.modeljars:modeljars-cli:0.1.17` to GitHub Packages, and updates the Integrallis Homebrew tap and
