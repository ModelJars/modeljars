...
```text
org.modeljars:modeljars:0.1.37
  -> org.modeljars:modeljars-core:0.1.37
  -> com.integrallis:models:0.3.36
  -> com.integrallis:backend-java:0.3.36
  -> com.integrallis:backend-native:0.3.36
```
...
`org.modeljars:modeljars-cli:0.1.37` to GitHub Packages, and updates the Integrallis Homebrew tap and
