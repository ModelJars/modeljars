...
```text
org.modeljars:modeljars:0.1.11
  -> org.modeljars:modeljars-core:0.1.11
  -> com.integrallis:models:0.3.3
  -> com.integrallis:backend-java:0.3.3
  -> com.integrallis:backend-native:0.3.3
```
...
`org.modeljars:modeljars-cli:0.1.11` to GitHub Packages, and updates the Integrallis Homebrew tap and
