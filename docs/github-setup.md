...
```text
org.modeljars:modeljars:0.1.38
  -> org.modeljars:modeljars-core:0.1.38
  -> com.integrallis:models:0.3.37
  -> com.integrallis:backend-java:0.3.37
  -> com.integrallis:backend-native:0.3.37
```
...
`org.modeljars:modeljars-cli:0.1.38` to GitHub Packages, and updates the Integrallis Homebrew tap and
