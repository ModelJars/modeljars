...
```text
org.modeljars:modeljars:0.1.28
  -> org.modeljars:modeljars-core:0.1.28
  -> com.integrallis:models:0.3.21
  -> com.integrallis:backend-java:0.3.21
  -> com.integrallis:backend-native:0.3.21
```
...
`org.modeljars:modeljars-cli:0.1.28` to GitHub Packages, and updates the Integrallis Homebrew tap and
