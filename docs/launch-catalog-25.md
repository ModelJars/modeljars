...
| 16 | HuatuoGPT-o1-7B | Medical reasoning | Apache-2.0 | Pinned trusted community Q4_K_M converted from the official weights | Supported by a mandatory exact-artifact pure-Java test; the marker retains its medical-use warning and conversion lineage. |
