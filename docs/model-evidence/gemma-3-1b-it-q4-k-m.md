...
| Models Rust/FFM, native decode | PRODUCTION_READY; qualified | 954.3 ms | 41.06 tok/s | 1,619.7 ms | 100% |
...
Models reaches 137.3% of Ollama and 84.0% of llama.cpp decode throughput. Its
...
decode. Native decode improves median throughput by 2.806x, p95 end-to-end
latency by 48.3%, and peak RSS by 32.4% over Java decode. All 27 raw
