...
class ModelToolQualificationRegistryTest {
  ...
  void refusesToCallSubstandardEvidenceQualified() {
    ...
    properties.setProperty(
        "toolQualification.cactus_compute_needle2_cact_cq2_mixed.expectedArgumentAccuracy",
        "0.89");
  ...
  private static ModelJarDescriptor descriptor(String sha256) {
    return new ModelJarDescriptor(
        ...
        ModelJarCoordinate.parse("org.modeljars.huggingface:cactus-compute.needle2.cact.cq2_mixed:2.0.0-cq2_mixed.1"),
